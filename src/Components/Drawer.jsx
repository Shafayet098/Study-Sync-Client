...
const Drawer = () => {
    ...
    return (
        <aside className="bg-black flex flex-col w-64 md:w-72  overflow-hidden  pt-4 ">
            ...
            <div className="flex flex-col justify-between flex-1 mt-6">
                <nav>
                    <div className="flex items-center px-4 py-2   rounded-lg hover:bg-secondary hover:text-gray-200" href="#">
                    ...
                    <a className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-secondary dark:hover:text-gray-200 hover:text-gray-700" href="#">
                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
