...
const UserAssignmentCard = ({ item, reloadData, reloadCount }) => {
            ...
            <div className=" overflow-hidden rounded-lg shadow-md bg-white/5 outline-1 outline-slate-800 hover:outline-primary">
                ...
                <div className="px-2 mb-2 flex gap-2">
                    ...
                    <button onClick={handleDelete}
                        className="flex w-full items-center text-center justify-center rounded-lg px-6 py-2 group bg-secondary bg-gradient-to-l from-slate-950 to-red-300 hover:bg-none  text-accent hover:ring-1 hover:ring-offset-2 ring-1 disabled:cursor-not-allowed  ring-red-700 hover:ring-fuchsia-600 duration-300  mt-5 ">
                        Delete
                    </button>
                </div>
            </div>
