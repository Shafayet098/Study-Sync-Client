                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-center">
                                <thead className=" bg-white/5 text-center">
                                    <tr className='text-center'>
                                        <th className='pl-2 text-gray-400
                                        text-center text-sm '>
                                            SL No.
                                        </th>
                                        <th className="pl-12 py-3.5 px-4 text-sm font-normal text-center  text-gray-500 dark:text-gray-400">
                                            <div className="flex items-center gap-x-3">
                                                <span>Assignment Title</span>
                                            </div>
                                        </th>

                                        <th scope="col" className="pl-16 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                        ...
                                        <th scope="col" className="pl-16 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Feedback</th>

                                        <th scope="col" className="pl-16 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Status</th>
